(function($) {
    ...
    $(".charity-slides").on("translate.owl.carousel", function() {
        $(".single-slider-items h1, .single-slider-items p").removeClass("animated fadeInUp").css("opacity", "0");
        $(".single-slider-items .row").removeClass("animated fadeInDown").css("opacity", "0");
    });
    $(".charity-slides").on("translated.owl.carousel", function() {
        $(".single-slider-items h1, .single-slider-items p").addClass("animated fadeInUp").css("opacity", "1");
